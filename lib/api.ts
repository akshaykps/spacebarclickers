const API_BASE_URL_DEFAULT = 'http://127.0.0.1:8000/api'
...
//   created_at: string
//   updated_at: string
//   // Added for robust state restoration from backend
//   achievements_unlocked_ids?: number[]
//   achievements_activated_ids?: number[]
// }
...
// // // console.log('API_BASE_URL configured as:', API_BASE_URL) // Added for debugging
